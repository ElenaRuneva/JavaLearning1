...
public class Task2 {
    public static void main(String[] args) {
        ChessPiece[][] boardArray = {
            ...
            {ChessPiece.ROOK_BLACK,ChessPiece.EMPTY,ChessPiece.KNIGHT_BLACK,ChessPiece.EMPTY,ChessPiece.EMPTY,ChessPiece.EMPTY,ChessPiece.PAWN_BLACK,ChessPiece.EMPTY},
