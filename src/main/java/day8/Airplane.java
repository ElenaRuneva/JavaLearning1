...
public class Airplane {
    ...
    public String toString() {
        ...
        sb.append("Manufacturer: " ).append(manufacturer).append(", year of manufacture: ").append(year);
        sb.append(", length: ").append(length).append(", weight: ").append(weight).append(", fuel balance: ").append(fuel);
        return sb.toString();
    }
}
